...
public enum CardType {
    RAYAQA_DA_TURAT("Rayaqa da Turat", 760, 3124,
    ...
    PROVINCE_VALDOR("Province Valdor", 100, 100,
    ...
    TAIKOK_DYNASTY("Taikok Dynasty", 550, 1945,
    ...
    CardType(String name, int atk, int hp,
